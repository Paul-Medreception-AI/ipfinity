        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-white rounded-2xl p-10 border border-[var(--color-border)] shadow-sm animate-fade-up">
            ...
            <div className="space-y-4 text-[var(--color-muted)] leading-relaxed">
              ...
              <p>SIP trunking eliminates the need for physical phone line infrastructure by connecting your existing PBX system directly to a cloud-based voice network. This means businesses can retain their current phone equipment while gaining access to advanced features like automatic failover, geographic redundancy, and unified global number management. The cost benefits are substantial: companies typically reduce telecommunications expenses by 30-50% while simultaneously improving call quality and reliability.</p>
              <p>What makes modern SIP trunking particularly compelling is its ability to bridge legacy and cloud-native environments. Whether you're running a decades-old PBX or a cutting-edge VoIP system, a properly configured SIP trunk seamlessly integrates with your existing infrastructure. This hybrid approach allows organizations to modernize at their own pace, protecting equipment investments while gradually adopting cloud-first communication strategies that scale with business growth.</p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 border border-[var(--color-border)] hover:shadow-lg transition-all animate-fade-up">
              ...
              <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-6">Direct Inward Dialing numbers give your business a local presence in any country without physical offices. Discover how global DIDs reduce international calling costs and improve customer accessibility across 150+ countries.</p>
              <Link href="/contact" className="inline-flex items-center gap-2 text-[var(--color-accent)] hover:text-[var(--color-accent-dark)] transition-colors text-sm font-medium">
                Read More →
              </Link>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 border border-[var(--color-border)] hover:shadow-lg transition-all animate-fade-up">
              ...
              <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-6">Transactional messages, appointment reminders, two-factor authentication—SMS remains the most reliable channel for critical communications. Learn how businesses leverage messaging APIs to automate workflows and improve customer engagement.</p>
              <Link href="/contact" className="inline-flex items-center gap-2 text-[var(--color-accent)] hover:text-[var(--color-accent-dark)] transition-colors text-sm font-medium">
                Read More →
              </Link>
            </div>
